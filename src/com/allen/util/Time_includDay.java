...
public class Time_includDay {
     ...
     * @param minute    分钟
     */
    public Time_includDay(int hour, int minute) {
     ...
     * @param second    秒
     */
    public Time_includDay(int hour, int minute, int second) {
     ...
     */
    public Time_includDay(String time) {
        this(time, null);
    }
     ...
     * @param second    秒
     */
    public Time_includDay(int day, int hour, int minute, int second) {
        set(DAY, day);
        set(HOUR, hour);
        set(MINUTE, minute);
        set(SECOND, second);
     ...
     * @param time      字符串格式的时间
     */
    public Time_includDay(String time, String timeSeparator) {
     ...
     * @return          运算后的时间
     */
    public Time_includDay addTime(Time_includDay time) {
        Time_includDay result = new Time_includDay();
        int up = 0;     // 进位标志
     ...
     * @return          运算后的时间
     */
    public Time_includDay subtractTime(Time_includDay time) {
        Time_includDay result = new Time_includDay();
        int down = 0;       // 退位标志
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final Time_includDay other = (Time_includDay) obj;
